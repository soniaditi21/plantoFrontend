    ...
    <Box className={classes.root}>
   
        {
            ...
            <Box className={classes.topContainer}>                          
                 <Typography className={classes.productshortTitle}>{lowmaintenanceplant.title.shortTitle}</Typography>
                  <Typography className={classes.productlongTitle}>{lowmaintenanceplant.title.longTitle}</Typography>
                 
                 <Carousel responsive={responsive}>
                 <img className={classes.mainIMG} src={lowmaintenanceplant.url1} alt='mainIMg'/>
                 <img className={classes.mainIMG} src={lowmaintenanceplant.url2} alt='mainIMg'/>
                 <img className={classes.mainIMG} src={lowmaintenanceplant.url3} alt='mainIMg'/>
                 <img className={classes.mainIMG} src={lowmaintenanceplant.url4} alt='mainIMg'/>
                 </Carousel>
              ...
              <Box className={classes.bottomContainer}>
                    ...
                    <Button className={classes.addToCartBtn} onClick={() => lmAddToCartItems(lowmaintenanceplant.id)} >Add to Cart</Button>
                    <Button className={classes.addToCartBtn} onClick={() => buyNow()} >Buy Now</Button>  
              </Box>


              <Box className={classes.discription}><Typography style={{fontSize: '30px',fontFamily: 'Times New Roman, Times, serif'}}>{lowmaintenanceplant.discription} </Typography></Box>
                ...
                <Box className={classes.LWA_container}>
                    <Typography className={classes.FirstHeading}>Lights, Water, Action</Typography>
                     ...
                     <Typography className={classes.three}>  {lowmaintenanceplant.features.light}</Typography> 
                     </Box>
                     ...
                     <img style={{width: '15%', height: '2%' }} src='https://www.ugaoo.com/media/wysiwyg/water.png' alt='endurl'/>  <Typography className={classes.two}>Watering</Typography>
                      ...
                      <Typography className={classes.three}>  {lowmaintenanceplant.features.watering}</Typography> 
                      </Box>
                      ...
                      <Typography className={classes.three}>  {lowmaintenanceplant.features.whereTogrow}</Typography> 
                      </Box>
                      ...
                      <Typography className={classes.three}>  {lowmaintenanceplant.features.maintenance}</Typography> 
                      </Box>
                      ...
                      <Typography className={classes.three}>  {lowmaintenanceplant.features.specialFeature}</Typography> 
                      </Box>

                   </Box>

                  <Box>
                     <img className={classes.rightContainer} src={lowmaintenanceplant.endurl} alt="endurl"/>
                </Box>
            ...
            <Box style={{margin: '50px'}}>
                ...
                <img  className={classes.rightContainer} src={lowmaintenanceplant.sizeMeUpUrl} alt="SizeMeUp" />
            </Box>
            ...
            <Box style={{margin: '50px'}}>
                ...
                <Box>
                     <Box className={classes.PCS}>
                        ...
                        <Typography className={classes.allHeadings}>{lowmaintenanceplant.plantEssentials.heading1}</Typography>
                     ...
                     <Typography className={classes.allHeadings}>{lowmaintenanceplant.commmonProblems.heading1}</Typography>
                         <Typography>{lowmaintenanceplant.commmonProblems.para1}</Typography>

                         <Typography className={classes.allHeadings}>{lowmaintenanceplant.commmonProblems.heading2}</Typography>
                     ...
                     <Box className={classes.PCS}>
                        ...
                        <Typography className={classes.allHeadings}>{lowmaintenanceplant.styleAndDecor.heading1}</Typography>
                         <Typography>{lowmaintenanceplant.styleAndDecor.para1}</Typography>

                         <Typography className={classes.allHeadings}>{lowmaintenanceplant.styleAndDecor.heading2}</Typography>
                         <Typography>{lowmaintenanceplant.styleAndDecor.para2}</Typography>

                         <Typography className={classes.allHeadings}>{lowmaintenanceplant.styleAndDecor.heading3}</Typography>
