...
const DetailView = ({ history, match }) => {
  ...
  const { airpurifyingitem } = useSelector(
    (state) => state.getAirPurifyingDetails
  );
        ...
        <Box className={classes.component}>
          <Box className={classes.topContainer}>
            <Typography className={classes.productshortTitle}>
              {airpurifyingitem.title.shortTitle}
            </Typography>
            <Typography className={classes.productlongTitle}>
              {airpurifyingitem.title.longTitle}
            </Typography>

            <Carousel responsive={responsive}>
              <img
                className={classes.mainIMG}
                src={airpurifyingitem.url1}
                alt="mainIMg"
              />
              <img
                className={classes.mainIMG}
                src={airpurifyingitem.url2}
                alt="mainIMg"
              />
              <img
                className={classes.mainIMG}
                src={airpurifyingitem.url3}
                alt="mainIMg"
              />
              <img
                className={classes.mainIMG}
                src={airpurifyingitem.url4}
                alt="mainIMg"
              />
            </Carousel>
          </Box>
          ...
          <Box className={classes.bottomContainer}>
            ...
            >
              <strike>₹{airpurifyingitem.price.strikeprice}</strike>
            </Typography>
            <Typography style={{ fontSize: "35px", marginLeft: "3%" }}>
              {" "}
              ₹{airpurifyingitem.price.actualprice}
            </Typography>
            <Button
              className={classes.addToCartBtn}
              onClick={() => apAddToCartItems(airpurifyingitem.id)}
            >
              Add to Cart
            </Button>
              ...
              <Box className={classes.leftContainer}>
                <Box style={{ padding: "20px" }}>
                  ...
                  <Typography className={classes.three}>
                    {" "}
                    {airpurifyingitem.features.light}
                  </Typography>
                </Box>
                ...
                <Box style={{ padding: "20px" }}>
                  ...
                  <Typography className={classes.three}>
                    {" "}
                    {airpurifyingitem.features.watering}
                  </Typography>
                </Box>
                ...
                <Box style={{ padding: "20px" }}>
                  ...
                  <Typography className={classes.three}>
                    {" "}
                    {airpurifyingitem.features.whereTogrow}
                  </Typography>
                </Box>
                ...
                <Box style={{ padding: "20px" }}>
                  ...
                  <Typography className={classes.three}>
                    {" "}
                    {airpurifyingitem.features.maintenance}
                  </Typography>
                </Box>
                ...
                <Box style={{ padding: "20px" }}>
                  ...
                  <Typography className={classes.three}>
                    {" "}
                    {airpurifyingitem.features.specialFeature}
                  </Typography>
                </Box>
              </Box>
          ...
          <Box style={{ margin: "50px" }}>
            ...
            <img
              className={classes.rightContainer}
              src={airpurifyingitem.sizeMeUpUrl}
              alt="SizeMeUp"
            />
          </Box>
            ...
            <Box>
              <Box className={classes.PCS}>
                ...
                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.plantEssentials.heading1}
                </Typography>
                <Typography>
                  {airpurifyingitem.plantEssentials.para1}
                </Typography>

                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.plantEssentials.heading2}
                </Typography>
                <Typography>
                  {airpurifyingitem.plantEssentials.para2}
                </Typography>

                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.plantEssentials.heading3}
                </Typography>
                <Typography>
                  {airpurifyingitem.plantEssentials.para3}
                </Typography>
              </Box>
              ...
              <Box style={{ marginLeft: "20%" }} className={classes.PCS}>
                ...
                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.commmonProblems.heading1}
                </Typography>
                <Typography>
                  {airpurifyingitem.commmonProblems.para1}
                </Typography>

                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.commmonProblems.heading2}
                </Typography>
                <Typography>
                  {airpurifyingitem.commmonProblems.para2}
                </Typography>

                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.commmonProblems.heading3}
                </Typography>
                <Typography>
                  {airpurifyingitem.commmonProblems.para3}
                </Typography>
              </Box>
              ...
              <Box className={classes.PCS}>
                ...
                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.styleAndDecor.heading1}
                </Typography>
                <Typography>{airpurifyingitem.styleAndDecor.para1}</Typography>

                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.styleAndDecor.heading2}
                </Typography>
                <Typography>{airpurifyingitem.styleAndDecor.para2}</Typography>

                <Typography className={classes.allHeadings}>
                  {airpurifyingitem.styleAndDecor.heading3}
                </Typography>
