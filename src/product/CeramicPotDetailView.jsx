      ...
      {ceramicpot && Object.keys(ceramicpot).length && (
        <Box className={classes.component}>
          ...
          <Box className={classes.bottomContainer}>
            ...
            >
              <strike>₹{ceramicpot.price.strikeprice}</strike>
            </Typography>
            <Typography style={{ fontSize: "35px", marginLeft: "3%" }}>
              {" "}
              ₹{ceramicpot.price.actualprice}
            </Typography>
            <Button
              className={classes.addToCartBtn}
              onClick={() => cpAddToCartItems(ceramicpot.id)}
            >
              Add to Cart
            </Button>
          ...
          <Box style={{ margin: "2% 5% 5% 5%" }}>
            ...
            <Box className={classes.additionalDetails}>
              <table>
                <tr>
                  <td>
                    <Typography className={classes.leftTD}>SKU</Typography>
                  </td>
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.sku}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  <td>
                    {" "}
                    <Typography className={classes.leftTD}>
                      PotBackImage
                    </Typography>
                  </td>
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.potBackImage}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.productWeight}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.productHeight}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.productWidth}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.productDepth}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  <td>
                    {" "}
                    <Typography className={classes.leftTD}>Category</Typography>
                  </td>
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.category}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  <td>
                    <Typography className={classes.leftTD}>Pots</Typography>
                  </td>
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.pots}
                    </Typography>
                  </td>
                </tr>
                <tr>
                  <td>
                    <Typography className={classes.leftTD}>Material</Typography>
                  </td>
                  <td>
                    <Typography className={classes.rightTD}>
                      {ceramicpot.additionalDetails.material}
                    </Typography>
                  </td>
                </tr>
              </table>
