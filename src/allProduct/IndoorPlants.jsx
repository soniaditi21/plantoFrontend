  ...
  return (
    <Box>
      <Box style={{ margin: '5% 2% 2% 2%', width: '100%', padding: '4%', textAlign: 'center' }}>
        <Typography  style={{ fontSize: '40px', fontFamily: 'Times Roman', textShadow: '#00403C 5px 14px 15px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px' }}>Indoor Plants</Typography>
        <Typography style={{ fontSize: '20px', fontFamily: 'Times Roman', textShadow: '#00403C 5px 14px 15px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px' }}>Little greenery inside the house revitalizes the soul and senses. Having indoor home plants have been practised for ages, but what has changed is the choice of plants.</Typography>
      </Box>
     ...
     >
      ...
      <Grid item md={4} >
         ...
         <Item  style={{backgroundColor: '#00403C', padding: '5% 2% 7% 1%', backgroundImage: `linear-gradient(to bottom,  rgba(0, 0, 0, 0.377) 0%,rgba(0, 0, 0, 0.866) 100%)`, borderRadius: '30px',  width: '90%', marginRight: '2%', '&:hover': { color:'white', boxShadow: '#88DAD2 0px 44px 145px, #88DAD2 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px',  }}}>
          ...
          <img style={{ width: '80%' }} src={indoorplant.url1} alt="" />
          <Typography style={{color: 'ivory', fontSize: '24px', fontFamily: 'Times Roman' }}>{indoorplant.title.shortTitle}</Typography>
 
          <Typography style={{color: 'ivory', fontSize: '20px'}}><strike style={{color: 'grey', marginRight: '2%'}}>₹{indoorplant.price.strikeprice}</strike> ₹{indoorplant.price.actualprice}</Typography>
        
          <Link to='/cart' style={{textDecoration: 'none'}}>  <Button onClick={() => ipAddToCartItems(indoorplant.id)} style={{ 
            backgroundColor: '#096C6E',
        color: 'ivory',
