     ...
     >
      ...
      <Grid item xs={12} sm={12} md={4}  >
         ...
         <Item  style={{backgroundColor: '#00403C', padding: '5% 2% 7% 1%', backgroundImage: `linear-gradient(to bottom,  rgba(0, 0, 0, 0.377) 0%,rgba(0, 0, 0, 0.866) 100%)`, borderRadius: '30px',  width: '90%', marginRight: '2%', '&:hover': { color:'white', boxShadow: '#88DAD2 0px 44px 145px, #88DAD2 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px',  }}}>
          ...
          <img style={{ width: '80%' }} src={herbseed.url1} alt="" />
          <Typography  style={{color: 'ivory', fontSize: '24px', fontFamily: 'Times Roman' }}>{herbseed.title.shortTitle}</Typography>
 
          <Typography style={{color: 'ivory', fontSize: '20px'}}><strike style={{color: 'grey', marginRight: '2%'}}>₹{herbseed.price.strikeprice}</strike> ₹{herbseed.price.actualprice}</Typography>
        
         <Link to='/cart' style={{textDecoration: 'none'}}>  <Button onClick={() => hsAddToCartItems(herbseed.id)} style={{ 
